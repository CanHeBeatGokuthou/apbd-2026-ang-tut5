...
namespace LegacyRenewalApp
{
    public class SubscriptionRenewalService
    {
        ...
        public SubscriptionRenewalService()
        {
            ...
            billingGateway = new LegacyBillingGatewayWrapper();
            discountCalculator = new DiscountCalculator(new List<IDiscountRule>
            {
                new SegmentDiscountRule(),
                new LoyaltyDiscountRule(),
                new VolumeDiscountRule(),
                new PointsDiscountRule()
            });
        }
        ...
        { 
            ...
            var discountResult = discountCalculator.CalculateAll(customer, plan, seatCount, baseAmount, useLoyaltyPoints);
